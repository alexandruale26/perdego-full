...
const PostTypeSelect = forwardRef(
  (
    { defaultValue = "pierdute", showLabel = true, formControl, className },
    ref,
  ) => {
    const [selected, setSelected] = useState(
      defaultValue === "pierdute" ? 0 : 1,
    );
    ...
    return (
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            {showLabel ? <p className="text-xl">Categorie anunț</p> : null}
            <FormControl>
              ...
              >
                ...
                <div className="relative w-full h-1 bg-grey-5 mt-0.5">
                  <div
